      ...
      <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
          <div class="row align-items-center">
            <div class="col-9">
              <h4 class="fw-semibold mb-8">Attendance today (<?=$dateNow;?>)</h4>
            ...
            <table class="table search-table align-middle text-nowrap">
              ...
              <tbody>
                ...
                foreach ($nurse_list as $row):
                  ...
                  $timeIn = "";
                  $timeOut = "";
                  $checkAttendance = attendance()->count("date='$dateNow' and nurseId=$row->Id");
                  if ($checkAttendance>0) {
                    $att = attendance()->get("date='$dateNow' and nurseId=$row->Id");
                    $timeIn = $att->timeIn;
                    $timeOut = $att->timeOut;
                  }
                ...
                <tr class="search-items">
                            ...
                            <div class="ms-3">
                              <div class="user-meta-info">
                                <h6 class="mb-0">
                                  ...
                                  <?php if ($timeIn!=""): ?>
                                    <?=format_time_to_12($timeIn);?>
                                  <?php endif; ?>
                                  <?php if ($timeOut!=""): ?>
                                    to <?=format_time_to_12($timeOut);?>
                                  <?php endif; ?>
                                </h6>
                              </div>
                            </div>
                  ...
                  <td>
                    <div class="action-btn">
                      <?php if ($checkAttendance==0): ?>
                          <a href="process.php?action=attendance-time-in&nurseId=<?=$row->Id?>" class="text-info btn btn-success">
                            Time In
                          </a>
                      <?php else:
                        $att = attendance()->get("date='$dateNow' and nurseId=$row->Id");
                         ...
                         <?php if ($att->timeOut==""): ?>
                            ...
                            <a href="process.php?action=attendance-time-out&nurseId=<?=$row->Id?>&attId=<?=$att->Id;?>" class="text-info btn btn-warning">
                              Time Out
                            </a>
                         <?php endif; ?>
                      <?php endif; ?>
